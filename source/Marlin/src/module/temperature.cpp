...
#define TEMPDIR(N) ((HEATER_##N##_RAW_LO_TEMP) < (HEATER_##N##_RAW_HI_TEMP) ? 1 : -1)
  ...
  constexpr temp_range_t sensor_heater_0={ HEATER_0_RAW_LO_TEMP, HEATER_0_RAW_HI_TEMP, 0, 250 }/*,  int16_t raw_min, raw_max, mintemp, maxtemp; 
...
void Temperature::manage_heater() {
  ...
  millis_t ms = millis();
    ...
    HOTEND_LOOP() {
        ...
        //if (degHotend(e) >(temp_range[e].maxtemp-15 )) max_temp_error((heater_id_t)e);  //
      #endif
