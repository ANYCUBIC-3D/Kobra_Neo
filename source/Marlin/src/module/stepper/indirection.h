...
// X Stepper
  ...
  #define X_ENABLE_INIT() OUT_WRITE(X_ENABLE_PIN,HIGH)//SET_OUTPUT(X_ENABLE_PIN)
...
// Y Stepper
  ...
  #define Y_ENABLE_INIT() OUT_WRITE(Y_ENABLE_PIN,HIGH)//SET_OUTPUT(Y_ENABLE_PIN)
...
// Z Stepper
  ...
  #define Z_ENABLE_INIT() OUT_WRITE(Y_ENABLE_PIN,HIGH)//SET_OUTPUT(Z_ENABLE_PIN)
...
// E0 Stepper
  ...
  #define E0_ENABLE_INIT() OUT_WRITE(Y_ENABLE_PIN,HIGH)//SET_OUTPUT(E0_ENABLE_PIN)
