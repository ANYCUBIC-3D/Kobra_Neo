...
const tImage Settings_32x32x1       = { (void *)settings_32x32x1, 32, 32, GREYSCALE1 };
...
const tImage Pause_48x48x1          = { (void *)pause_48x48x1, 48, 48, GREYSCALE1 };
const tImage SD_48x48x1             = { (void *)sd_48x48x1, 48, 48, GREYSCALE1 };
const tImage Stop_48x48x1           = { (void *)STOP_48x48x1, 48, 48, GREYSCALE1 };

const tImage Images[imgCount] = {
  NoLogo,//TERN(SHOW_BOOTSCREEN, TERN(BOOT_MARLIN_LOGO_SMALL, MarlinLogo195x59x16, MARLIN_LOGO_FULL_SIZE), NoLogo),
  HotEnd_64x64x4,
  Bed_64x64x4,
  Bed_Heated_64x64x4,
  Chamber_64x64x4,
