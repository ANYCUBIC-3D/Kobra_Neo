...
// if(ui.language) //english
// {
//	 MENU_ITEM_P(function, GET_LANG(LCD_LANGUAGE_2  )::LANGUAGE, []{ set_lcd_language(0); });
//     MENU_ITEM_P(function, GET_LANG(LCD_LANGUAGE_2  )::LANGUAGE_2, []{ set_lcd_language(1); });
// }
// else
// {
//	 MENU_ITEM_P(function, GET_LANG(LCD_LANGUAGE)::LANGUAGE, []{ set_lcd_language(0); });
//  	 MENU_ITEM_P(function, GET_LANG(LCD_LANGUAGE)::LANGUAGE_2, []{ set_lcd_language(1); });
// }
