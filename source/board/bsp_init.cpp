...
void clock_init(void)
{
    ...
    MEM_ZERO_STRUCT(stcMpllCfg);
	   ...
	   /* Set bus clk div. */
    stcSysClkCfg.enHclkDiv  = ClkSysclkDiv1; /*8M*/
...
//    /* Set bus clk div. */
//	  stcSysClkCfg.enHclkDiv  = ClkSysclkDiv1; /*16M*/
//    stcSysClkCfg.enExclkDiv = ClkSysclkDiv2;
//    stcSysClkCfg.enPclk0Div = ClkSysclkDiv1;
//    stcSysClkCfg.enPclk1Div = ClkSysclkDiv1;
//    stcSysClkCfg.enPclk2Div = ClkSysclkDiv2;
//    stcSysClkCfg.enPclk3Div = ClkSysclkDiv2;
//    stcSysClkCfg.enPclk4Div = ClkSysclkDiv8;
//    CLK_SysClkConfig(&stcSysClkCfg);
...
//    stcMpllCfg.PllpDiv = 2ul;	/* MLLP = 200M */
//    stcMpllCfg.PllqDiv = 2ul;	/* MLLQ = 200M */
//    stcMpllCfg.PllrDiv = 2ul;	/* MLLR = 200M */
